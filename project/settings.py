...
SECRET_KEY = 'django-insecure-1=doteg68kzs8q=6r9^*3hv$_h1ktc&f0lys&+f)4r++q--=!s'
...
STATIC_ROOT = BASE_DIR / 'static' #collectstatic faz uma pastas..

# media quando o usuario envia uma foto...essa media_url nao vem por padrao do django..
MEDIA_URL = 'media/'
